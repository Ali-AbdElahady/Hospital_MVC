        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Pharmacys_Pharmacy_ID",
                        column: x => x.Pharmacy_ID,
                        principalTable: "Pharmacys",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Specializations_Specialization_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_AspNetUsers_Patient_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prescriptions_AspNetUsers_Patient_ID",
                        column: x => x.Patient_ID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_AspNetUsers_Patient_ID",
                        column: x => x.Patient_ID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Rooms_AspNetUsers_Staff_ID",
                        column: x => x.Staff_ID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Pharmacy_ID",
                table: "AspNetUsers",
                column: "Pharmacy_ID");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Specialization_ID",
                table: "AspNetUsers",
